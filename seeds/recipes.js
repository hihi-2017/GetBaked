  ...
  return knex('recipes').del()
    .then(function () {
      return Promise.all([
        ...
        knex('recipes').insert({recipe_id: 99902, category_name:'Bread', category_id: 2202, recipe_name: 'Bread', chef_name: 'Dr. Bread', recipe_image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnUDAzKLRLbzB1zeiZk2LPgIBuIwrI_zcIWuvip_5YZY-I9ypq', recipe_ingredients: 'bread', recipe_method:
        'Make the bread', recipe_comments: "It's bready."}),

        knex('recipes').insert({recipe_id: 99903, category_name:'Pies, Crumbles, and Tarts', category_id: 2203, recipe_name: 'Raspberry Pie', chef_name: 'Pie Lady', recipe_image_url: 'http://clv.h-cdn.co/assets/15/12/640x640/square-1426610944-138638408.jpg', recipe_ingredients: 'Pie', recipe_method:
