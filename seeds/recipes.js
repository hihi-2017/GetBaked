  ...
  return knex('recipes').del()
    .then(function () {
      return knex('recipes').insert([
        ...
        { recipe_id: 15, category_name: 'Cookies and Bars', category_id: 2203, recipe_name: 'Peanutbutter Cookies', chef_name: 'Dr. P. E. Nut III',
